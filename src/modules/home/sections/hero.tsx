...
export const HomeHero = () => {
  return (
    <section className="relative space-y-4 px-4 py-12 text-center sm:space-y-6 sm:py-16 md:h-screen md:py-20 lg:space-y-8">
      <div className="space-y-2 sm:space-y-3 lg:space-y-4">
        ...
        <h1 className="text-balance font-moret font-semibold text-4xl text-brand-foreground sm:text-5xl md:text-6xl lg:text-7xl">
      ...
      <Button className="text-sm sm:text-base">
        Explore Collections
        <div className="flex size-8 items-center justify-center rounded-full bg-white sm:size-10">
      ...
      <div className="-z-9 absolute inset-0 h-full w-full bg-[linear-gradient(to_right,var(--background)_1px,transparent_1px),linear-gradient(to_bottom,var(--background)_1px,transparent_1px)] bg-[size:20px_20px] md:bg-[linear-gradient(to_right,var(--background)_1px,transparent_1px),linear-gradient(to_bottom,var(--background)_1px,transparent_1px)]" />
