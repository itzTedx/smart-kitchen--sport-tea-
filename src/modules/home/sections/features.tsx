...
export const HomeFeatures = () => {
  return (
    <section className="-mt-16 relative z-2 bg-gradient-to-b from-background/75 to-10% to-background py-14 backdrop-blur-xl md:py-24 lg:py-32">
      <div className="space-y-3 px-4 pb-8 text-center md:px-6 md:pb-12 lg:pb-16">
        <h2 className="text-2xl text-brand-foreground md:text-3xl lg:text-3xl">
          Crafted by Nature,
          <br />
      ...
      <div className="container grid max-w-7xl grid-cols-1 gap-3 px-4 md:px-6 lg:grid-cols-12">
        <div className="grid gap-3 lg:col-span-7">
          <div className="rounded-xl bg-white p-4 text-center text-brand-foreground md:p-6 lg:p-7">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-7">
            <div className="grid gap-3 md:col-span-3">
              <div className="flex items-center justify-center gap-2 rounded-xl bg-white py-4 md:gap-2 md:py-5 xl:gap-4">
              ...
              <div className="rounded-xl bg-white p-4 md:p-6 lg:p-7">
            ...
            <div className="relative flex flex-col justify-end overflow-hidden rounded-xl bg-white p-4 text-center md:col-span-4 md:p-6 lg:p-7">
          ...
          <div className="flex flex-col items-start justify-between gap-4 rounded-xl bg-white p-4 md:flex-row md:items-center md:gap-2 md:p-6 lg:p-7">
            ...
            <Button className="w-full gap-2 md:w-auto md:gap-4">
              Talk to our expert{" "}
        ...
        <div className="relative mt-3 flex flex-col justify-between overflow-hidden rounded-xl bg-white p-4 md:p-6 lg:col-span-5 lg:mt-0 lg:p-7">
          ...
          <div className="z-1 mt-4 w-fit space-y-3 rounded-xl bg-gradient-to-b from-white/60 to-white/40 p-3 backdrop-blur-lg md:mt-6">
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="flex items-center gap-1">
                    <IconLocationPin className="size-4 text-primary md:size-5" />
                ...
                <IconMountain className="size-8 md:size-10" />
              </div>
              <Separator />
            ...
            <div className="flex items-center gap-3 rounded-lg bg-white p-4 md:p-5">
              <div className="flex size-10 shrink-0 items-center justify-center rounded-md bg-secondary text-white md:size-12">
