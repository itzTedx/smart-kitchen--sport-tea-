...
const buttonVariants = cva(
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium text-base outline-none transition-all duration-300 ease-in-out focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-secondary-hover/60 bg-secondary-foreground/60 text-secondary shadow-xs backdrop-blur-xl hover:scale-102 hover:border-secondary-hover/80 hover:bg-accent hover:text-accent-foreground hover:shadow-md active:scale-[0.98]",
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:scale-102 hover:bg-secondary/80 hover:shadow-md active:scale-[0.98]",
        ghost:
          "hover:scale-102 hover:bg-accent hover:text-accent-foreground active:scale-[0.98] dark:hover:bg-accent/50",
        link: "text-primary underline-offset-4 hover:scale-102 hover:underline active:scale-[0.98]",
        cta: "inset-shadow-[0_2px_4px_0] inset-shadow-[oklch(0.9108_0.0708_72.95)]/40 border-white/40 border-b bg-gradient-to-b from-secondary to-secondary-hover text-white shadow-[0_8px_9px_0_oklch(0.3503_0.0703_168.79/0.06),_0_4px_9px_0_oklch(0.3503_0.0703_168.79/0.3),_0_4px_6px_0_oklch(0.5534_0.1128_167.45/0.2)] hover:scale-102 hover:border-transparent hover:from-secondary-hover hover:to-secondary-hover/90 hover:shadow-[0_12px_12px_0_oklch(0.3503_0.0703_168.79/0.02),_0_6px_12px_0_oklch(0.3503_0.0703_168.79/0.04),_0_6px_8px_0_oklch(0.5534_0.1128_167.45/0.08)] active:scale-[0.98] dark:border-foreground/20",
      },
      size: {
